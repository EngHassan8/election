...
function About() {
  return (
    ...
    <div className="bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative bg-gradient-to-r from-blue-800 to-blue-600 py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-blue-100 mt-6 mb-4">
            <span className="block">Dimuqraadiyadda Dib loo Abuuro</span>
            <span className="block font-normal mt-1">
              Platformka Doorashooyinka Teknolojiyada
            </span>
          </h2>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-blue-100/90">
              Qalabka doorashooyinka ee heer ganacsi oo ay kalsoonida yihiin
              dawladaha iyo ururada caalamiga ah
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {[
              ...
              { value: "99.99%", label: "Uptime", so: "Waagii shaqeynta" },
              {
                value: "Zero",
                label: "Security Breaches",
                so: "Xadgudub Ammaan",
              },
              { value: "128-bit", label: "Encryption", so: "Xaqiijin" },
            ].map((stat, index) => (
              <div
                key={index}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Mission Section */}
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden mb-16 border border-gray-100">
          <div className="md:flex">
            <div className="md:w-1/3 bg-gradient-to-br from-blue-700 to-blue-600 p-8 flex flex-col justify-center">
              <FaBullseye className="text-6xl text-white opacity-90 mx-auto mb-4" />
              <h3 className="text-xl font-bold text-white text-center">
                Ujeedada / Our Mission
              </h3>
            </div>
            <div className="md:w-2/3 p-10">
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Waxaan ku dadaalaynaa inaan horumarino hababka doorashooyinka
                ...
                . Platformkeenu wuxuu awood u siinayaa ururada inay ku qabtaan
                doorashooyin ay ku kalsoon yihiin xaqiijinta iyo saxnaanta.
              </p>
          ...
          {[
            {
              ...
              title: "Amaan Aan Jebin Karin",
              titleEn: "Unbreakable Security",
              desc: "Xaqiijinta blockchain iyo xiratada si toos ah u hubinaysa in codkaagu si qarsoodi ah u sii socdo",
              descEn:
                "Blockchain verification and end-to-end encryption ensure vote anonymity",
            },
            {
              icon: <FaGlobe className="text-3xl text-blue-600" />,
              title: "Helitaan Caalami",
              titleEn: "Global Access",
              desc: "Isticmaalka qalab kasta oo internetka heli kara, meel kasta oo aad joogto",
              descEn:
                "Accessible from any internet-connected device, anywhere in the world",
            },
            {
              icon: <FaChartLine className="text-3xl text-blue-600" />,
              title: "Natiijooyin Degdeg Ah",
              titleEn: "Instant Results",
              desc: "Xisaabinta degdeg ah ee leh caddaymo cryptographic si loo helo natiijooyin la xaqiijin karo",
              descEn:
            ...
            >
              ...
              <p className="text-gray-500 text-sm text-center">{item.descEn}</p>
            </div>
          ))}
        </div>

        {/* Technology Stack */}
        <div className="bg-gradient-to-r from-blue-800 to-blue-700 rounded-2xl shadow-2xl p-12 mb-16">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-2">
              Teknolojiyada / Technology Stack
            </h2>
            <div className="w-24 h-1 bg-blue-400 mx-auto mb-8"></div>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { name: "Zero-Knowledge Proofs", so: "Caddaymo Aan La Ogeyn" },
                { name: "Blockchain Anchoring", so: "Xaqiijinta Blockchain" },
                { name: "End-to-End Encryption", so: "Xiratada Tooska ah" },
                { name: "Biometric Auth", so: "Xaqiijinta Biomterik" },
              ].map((tech, index) => (
                <div
                  key={index}
                  className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20"
        ...
        <div className="bg-white rounded-xl shadow-2xl p-12 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              "Platformkan waa kan kaliya oo buuxiyay shuruudaha ammaankeena
              adiga oo siinaya helitaanka ay u baahan yihiin bulshadeena."
              <br />
              <br />
            ...
            <div className="flex items-center justify-center">
              <div className="text-left">
                <p className="font-semibold text-gray-800">Dr. Aisha Mohamed</p>
                <p className="text-blue-600">
                  Gudoomiye, Ururka Dimuqraadiyadda Soomaaliya
                </p>
