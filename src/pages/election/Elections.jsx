...
function Elections() {
  ...
  const [Position, setPosition] = useState(""); // ✅ sax spelling
  ...
  useEffect(() => {
    axios
      .get("https://back-1-374m.onrender.com/get/election")
      .then((res) => {
  ...
  const HandleNewElection = (e) => {
    ...
    axios
      .post("https://back-1-374m.onrender.com/new/elction", {
        Name,
        Position, // ✅ sax
        StartDate,
        EndDate,
  ...
  const handleTotalE = () => {
    axios
      .get("https://back-1-374m.onrender.com/total/election")
      .then((res) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://back-1-374m.onrender.com/remove/election/${id}`)
      .then(() => {
        ...
        <div className="bg-gray-100 p-6 rounded shadow-md">
          ...
          {elections.length > 0 ? (
            elections.map((election, index) => (
              <div
                key={index}
                className="grid grid-cols-5 text-gray-700 border-b py-2"
              >
                ...
                <span className="flex gap-4">
                  <button className="text-blue-600 hover:underline font-bold text-2xl">
                    <IoRefreshCircle />
                  </button>
